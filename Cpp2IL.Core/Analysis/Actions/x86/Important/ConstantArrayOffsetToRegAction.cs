...
namespace Cpp2IL.Core.Analysis.Actions.x86.Important
{
    public class ConstantArrayOffsetToRegAction : BaseAction<Instruction>
    {
        ...
        public override Mono.Cecil.Cil.Instruction[] ToILInstructions(MethodAnalysis<Instruction> context, ILProcessor processor)
        {
            ...
            ret.Add(processor.Create(OpCodes.Ldelem_Any, (_elementType is GenericInstanceType git) ? processor.ImportRecursive(git) : processor.ImportReference(_elementType)));

...
namespace Cpp2IL.Core.Analysis.Actions.x86.Important
{
    public class RegToStaticFieldAction : AbstractStaticFieldWriteAction<Instruction>
    {
        ...
        {
            _sourceOperand = context.GetOperandInRegister(X86Utils.GetRegisterNameNew(instruction.Op1Register));
            var destStaticFieldsPtr = context.GetConstantInReg(X86Utils.GetRegisterNameNew(instruction.MemoryBase));

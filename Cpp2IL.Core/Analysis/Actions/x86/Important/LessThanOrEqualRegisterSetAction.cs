...
{
    public class LessThanOrEqualRegisterSetAction : ConditionalRegisterSetAction
    {
        public LessThanOrEqualRegisterSetAction(MethodAnalysis<Instruction> context, Instruction instruction) : base(context, instruction)
        {
        }

...
{
    public class MultiplyRegByGlobalAction : BaseAction
    {
        ...
        public MultiplyRegByGlobalAction(MethodAnalysis context, Instruction instruction) : base(context, instruction)
        {

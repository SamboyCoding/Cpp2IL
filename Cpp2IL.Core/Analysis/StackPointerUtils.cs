...
namespace Cpp2IL.Core.Analysis
{
    ...
    {
        public static LocalDefinition<Instruction>? GetLocalReferencedByEBPRead(MethodAnalysis<Instruction> context, Instruction instruction)
        {
        ...
        public static int SaveLocalToStack(MethodAnalysis<Instruction> context, Instruction savingInstruction, LocalDefinition<Instruction> theLocal)
        {

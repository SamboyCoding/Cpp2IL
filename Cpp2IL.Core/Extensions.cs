...
namespace Cpp2IL.Core
{
    public static class Extensions
    {
        ...
        public static ulong GetInstructionAddress(this object? instruction) => instruction == null ? 0 : AnalysisUtils.GetAddressOfInstruction(instruction);
        
        public static ulong GetNextInstructionAddress(this object? instruction) => instruction == null ? 0 : AnalysisUtils.GetAddressOfNextInstruction(instruction);

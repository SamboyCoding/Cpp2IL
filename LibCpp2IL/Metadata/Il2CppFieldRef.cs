...
public class Il2CppFieldRef : ReadableClass
{
    ...
    public Il2CppType? DeclaringType => OwningBinary?.GetType(typeIndex);

    public Il2CppTypeDefinition? DeclaringTypeDefinition => OwningMetadata?.GetTypeDefinitionFromIndex(DeclaringType!.Data.ClassIndex);

    public Il2CppFieldDefinition? FieldDefinition => OwningMetadata?.GetFieldDefinitionFromIndex(DeclaringTypeDefinition!.FirstFieldIdx + fieldIndex);
